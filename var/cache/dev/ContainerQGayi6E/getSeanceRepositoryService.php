 ...
 */
class getSeanceRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SeanceRepository' shared autowired service.
     *
     * @return \App\Repository\SeanceRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SeanceRepository.php';

        return $container->privates['App\\Repository\\SeanceRepository'] = new \App\Repository\SeanceRepository(($container->services['doctrine'] ?? $container->getDoctrineService()));
    }
}
