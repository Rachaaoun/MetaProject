...
class getRouting_LoaderService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'captcha-com'.\DIRECTORY_SEPARATOR.'symfony-captcha-bundle'.\DIRECTORY_SEPARATOR.'Routing'.\DIRECTORY_SEPARATOR.'CaptchaRoutesLoader.php';
        ...
        $a->addLoader(new \Captcha\Bundle\CaptchaBundle\Routing\CaptchaRoutesLoader());
        $a->addLoader($c);
